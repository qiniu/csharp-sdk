...
namespace Qiniu.FileOp
{
    ...
    {
        protected static string[] Gravitys = new string[9] { "NorthWest", "North", "NorthEast", "West", "Center", "East", "SouthWest", "South", "SouthEast" };
        protected int dx;
        protected int dy;
        ...
        public virtual string MakeRequest(string url) { return null; }
