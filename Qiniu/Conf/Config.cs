...
namespace Qiniu.Conf
{
    public class Config
    {
        ...
        public static string SECRET_KEY = "<Dont send your secret key to anyone>";// 不要在客户端初始化该变量

        public static string RS_HOST = "http://rs.Qiniu.me";
        public static string UP_HOST = "http://up.qiniu.com";
        public static string RSF_HOST = "http://rsf.Qiniu.me";
