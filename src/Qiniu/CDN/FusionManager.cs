...
namespace Qiniu.CDN
{
    ...
    public class FusionManager
    {
        ...
        /// <summary>
        /// 生成管理凭证(请求主体为空，body=null)
        /// </summary>
        /// <param name="url">功能入口URL</param>
        ...
        public RefreshResult refresh(RefreshRequest request)
        {
            ...
            try
            {
                ...
                string token = createManageToken(url);
        ...
        /// <returns>日志列表</returns>
        public LogListResult getLogList(string[] domains,string date)
        {
        ...
        public string hotLink(HotLinkRequest request)
        {
            ...
            string SIGN = StringHelper.calcMD5(key + path + file + ts);
        ...
        /// <returns>已授权链接(包含过期时间戳)</returns>
        public string getAntileechUrl(string host, string path, string fileName, string query, string encryptKey, int expireInSeconds)
        {
